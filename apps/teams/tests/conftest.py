...
from .factories import AcceptedTeamMemberFactory, TeamFactory
...
@pytest.fixture
def hackathon():
    """Registration open, submission deadline comfortably in the future --
    same margin reasoning as apps.registrations.tests.conftest.published_hackathon."""
...
def team(owner, hackathon, owner_registration):
    """A team already owned by `owner`, with `owner` as its sole accepted
    member -- the shape most invite/leave/roster tests want."""
